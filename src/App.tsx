...
const initialShabadList: ShabadItem[] = [
  ...
  {
    id: "havan",
    title: "प्रातःकालीन-सायङ्कालीन वैदि-हवन-मन्त्राः",
    icon: BookOpenText,
  },
  { id: "gotra", title: "अथ गोत्रचार प्रारम्भ", icon: BookOpenText },
  { id: "s1", title: "शब्द 1", icon: BookOpenText },
  { id: "s2", title: "शब्द 2", icon: BookOpenText },
  { id: "s3", title: "शब्द 3", icon: BookOpenText },
  { id: "s4", title: "शब्द 4", icon: BookOpenText },
  { id: "s5", title: "शब्द 5", icon: BookOpenText },
  { id: "s6", title: "शब्द 6", icon: BookOpenText },
];

const initialAartiList: ShabadItem[] = [
  {
    id: "aarti1",
    title: "जाम्भोजी की आरती",
    icon: Music,
    audioUrl: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3",
    text: "आरती श्री जाम्भेश्वर जी की...\n\n(यहाँ आरती के सम्पूर्ण बोल आएँगे।)\n\nधूप दीप नैवेद्य आरती...",
  },
];
...
const initialBhajanList: ShabadItem[] = [
  {
    id: "bhajan1",
    title: "भजन: गुरु महिमा",
    icon: Music,
    audioUrl: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3",
    text: "गुरु ब्रह्मा गुरु विष्णु...\n\n(भजन के बोल यहाँ प्रदर्शित होंगे)",
  },
];
...
const initialSakhiList: ShabadItem[] = [
  {
    ...
    text: "साखी के बोल यहाँ प्रदर्शित होंगे...",
  },
];
...
const sampleText = `ओ३म् गुरु चीन्हों गुरु चिन्ह पुरोहीत, गुरु मुख धर्म बखाणी । जो गुरु होयबा सहजै शीले शब्दे नादे वेदे, तिहिं गुरु का आलिंकार पिछाणी । छव दरशण जिहिं कै रुपण थापण, संसार बरतन निज कर थरप्या, सो गुरु प्रत्यक्ष जाणी । जिहिं कै खर तर गोठ निरोतर बाचा, रहिया रुद्र समाणी । गुरु आप संतोषी अवरां पोषी, तत्त्व महारस बाणी । के के अलिया बासण होत हुताषण तामै क्षीर दुहीजूं । रसुवन गोरस घीय न लीयूं, तहां दुध न पाणी । गुरु ध्याइयेरे ज्ञानी । तोड़त मोहा अति खुरसांणी, छीजत लोहा पाणी। छल तेरी खाल पखाला, सतगुरु तोडे मन का साला । सतगुरु है तो सहज पिछाणी, कृष्ण चरित्र बिन काचे करवे रह्यो न रहसी पाणी ॥१॥`;
...
export default function App() {
  ...
  const [notifications, setNotifications] = useState<Notification[]>([
    ...
    },
    {
      id: "n2",
      title: "भक्त योगदान",
      message: "अब आप भी अपने भजन और आरती ऐप में जोड़ सकते हैं।",
      date: "कल",
      read: false,
    },
  ]);
      ...
      try {
        await navigator.share({
          ...
          text:
            ...
            (selectedShabad?.text || sampleText).substring(0, 100) +
            "...",
                    ...
                    try {
                      if (contribType === "मेले") {
                        ...
                        if (contribType === "शब्द") {
                          ...
                          await addDoc(collection(db, "thoughts"), { text: contribText });
