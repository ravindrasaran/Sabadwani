    ...
    >
      ...
      <div className="px-6 pt-2 text-center">
        ...
        <div className="bg-white/80 p-6 rounded-3xl shadow-md border border-ink/10 text-left space-y-4 text-sm md:text-base text-ink">
          ...
          <p className="text-xs text-ink/70 mb-4">अंतिम अपडेट: 08 जून 2026</p>
          ...
          <ul className="list-disc pl-5 space-y-1 text-ink/90">
            <li><strong>व्यक्तिगत जानकारी:</strong> जब आप ऐप में लॉगिन करते हैं (Google One-Click Authentication के माध्यम से), तो हम आपका नाम, ईमेल पता और प्रोफाइल फोटो सुरक्षित रूप से प्राप्त करते हैं।</li>
            <li><strong>मोबाइल नंबर और 4-अंकीय MPIN:</strong> यदि आप मोबाइल नंबर के जरिए रजिस्टर/लॉगिन करते हैं, तो हम आपका पूरा नाम, वैध 10-अंकों का मोबाइल नंबर और आपके द्वारा बनाया गया 4-अंकीय सुरक्षित MPIN (एन्क्रिप्टेड पासवर्ड रूप में) एकत्र और डेटाबेस में सुरक्षित स्टोर करते हैं, ताकि आप सुरक्षित रूप से लॉग-इन कर सकें।</li>
            <li><strong>प्रोफ़ाइल फोटो और कस्टमाइजेशन:</strong> आप ऐप में कस्टमाइज्ड अवतार या अपनी प्रोफ़ाइल फोटो अपलोड कर सकते हैं, जिसे क्लाउड स्टोरेज पर सुरक्षित रूप से होस्ट किया जाता है।</li>
