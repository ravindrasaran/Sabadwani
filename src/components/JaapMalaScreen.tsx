  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col items-center justify-center relative px-4 w-full max-w-lg mx-auto">
        <div className="text-5xl sm:text-6xl md:text-7xl font-heading text-accent mb-4 drop-shadow-sm z-10 flex items-center justify-center w-32 h-32 sm:w-40 sm:h-40 bg-white/50 rounded-full shadow-inner border border-ink/10">{malaCount}</div>
        ...
        <div className="relative flex items-center justify-center w-full max-w-[300px] aspect-square mt-6 mb-10">
          {/* Decorative background rings */}
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none opacity-5">
            <div className="w-full h-full rounded-full border-[12px] border-ink"></div>
            <div className="absolute w-[120%] h-[120%] rounded-full border-[2px] border-ink border-dashed"></div>
          </div>

          <button 
            onClick={onJap}
            className="relative w-full h-full rounded-full bg-gradient-to-br from-accent to-accent-dark text-white shadow-2xl flex items-center justify-center active:scale-95 transition-all border-[8px] border-white/30 group z-10"
          >
            <div className="absolute inset-0 rounded-full bg-white/20 opacity-0 group-active:opacity-100 transition-opacity"></div>
            <span className="text-2xl sm:text-3xl font-bold font-heading tracking-wider">जाप करें</span>
          </button>
        </div>
